      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-3">
        <div className="lg:col-span-2">
          ...
          <div className="mt-6 space-y-4">
            <HealthProductRecommendations category={cat} limit={4} page={`/blog/category/${slug}`} title={`${cat} — Recommended Products`} />
            <MonetizationCTA pageType="blog" page={`/blog/category/${slug}`} />
            <AffiliateProducts limit={4} title={`${cat} — Affiliate Picks`} />
            <AdBanner placement="article_middle" page={`/blog/category/${slug}`} />
            <AdRectangle placement="article_bottom" page={`/blog/category/${slug}`} />
        ...
        <div className="space-y-4">
          <PremiumCTA compact />
          <AdBanner placement="products_sidebar" page={`/blog/category/${slug}`} />
