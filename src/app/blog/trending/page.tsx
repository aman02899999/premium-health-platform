      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-3">
        <div className="lg:col-span-2">
          ...
          <div className="mt-6 space-y-4">
            <HealthProductRecommendations limit={4} page="/blog/trending" title="Trending — Recommended" />
            <MonetizationCTA pageType="blog" page="/blog/trending" />
            <AdBanner placement="article_middle" page="/blog/trending" />
            <AdRectangle placement="article_bottom" page="/blog/trending" />
        ...
        <div className="space-y-4">
          <PremiumCTA compact />
          <AdBanner placement="products_sidebar" page="/blog/trending" />
