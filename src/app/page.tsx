          ...
          <div className="mt-8 grid gap-6 lg:grid-cols-3">
            <div className="space-y-4">
              ...
              <div className="grid gap-3">
                <Link href="/store/indian-diabetes-diet-guide" className="rounded-2xl border border-stone-200 bg-white p-4 hover:border-emerald-300 dark:border-stone-700 dark:bg-stone-900">
                ...
                <Link href="/store/30-day-indian-weight-management-plan" className="rounded-2xl border border-stone-200 bg-white p-4 hover:border-emerald-300 dark:border-stone-700 dark:bg-stone-900">
                ...
                <Link href="/store" className="text-xs font-bold text-emerald-700 underline">Explore Store — All Guides →</Link>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid gap-3">
                <Link href="/health-calculators" className="rounded-2xl border border-stone-200 bg-white p-4 hover:border-emerald-300 dark:border-stone-700 dark:bg-stone-900">
                ...
                <Link href="/premium" className="rounded-2xl bg-gradient-to-br from-stone-900 to-emerald-900 p-4 text-white">
