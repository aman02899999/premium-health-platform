...
import { Breadcrumbs, TopicCard, InfoNote, AdSlot, EvidenceBadge, DisclaimerBar } from "@/components/ui";
...
const seoDescription = "Dosha, dinacharya, ritucharya, nutrition, panchakarma education and herb safety — traditional wisdom distinguished from clinical evidence. SEO pro + ItemList.";
const url = "/ayurveda";
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8">
      ...
      <div className="hero-pattern mt-3 rounded-3xl border border-emerald-100 p-6 md:p-8 dark:border-stone-700">
        <p className="flex items-center gap-2 text-[11px] font-bold uppercase tracking-[0.2em] text-amber-600"><Sparkles className="h-4 w-4" /> Traditional wellness, responsibly presented — SEO Pro + Earning Platform</p>
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          {[["Dosha Basics", "/ayurveda/dosha-basics"], ["Dinacharya", "/ayurveda/dinacharya-daily-routine"], ["Nutrition", "/ayurveda/ayurvedic-nutrition"], ["Panchakarma", "/ayurveda/panchakarma-education"], ["All Herbs", "/herbs"], ["Dosha Meals", "/dosha-meals"], ["Ritucharya Planner", "/ritucharya"]].map(([l, h]) => (
      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-3">
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-3xl border border-stone-200 bg-white p-5 dark:border-stone-700 dark:bg-stone-900">
            <h3 className="text-sm font-bold">Why Ayurveda is SEO Pro + Earning</h3>
            <ul className="mt-2 list-disc pl-5 text-xs text-stone-600 dark:text-stone-300">
              <li>{AYURVEDA_TOPICS.length} topics + {HERBS.length} herbs with evidence level + safety + interactions</li>
              <li>Earning: Ayurveda kit + books affiliate + premium dosha meals + ritucharya planner</li>
              <li>SEO: FAQ + HowTo + Breadcrumb + OG /api/og + ItemList JSON-LD + internal linking to dosha-meals/ritucharya/herb-interaction</li>
            </ul>
          </div>
        </div>
      </div>
